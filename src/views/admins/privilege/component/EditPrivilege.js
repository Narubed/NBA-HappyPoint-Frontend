...
export default function CreateMembers() {
  ...
  const [values, setValues] = React.useState({
    pvl_name: valueState.pvl_name,
    pvl_point: valueState.pvl_point,
    pvl_code: valueState.pvl_code,
    pvl_grop_level: valueState.pvl_grop_level,
    pvl_limited_total: valueState.pvl_limited_total,
    pvl_limited_member: valueState.pvl_limited_member,
    pvl_date_start: valueState.pvl_date_start,
  ...
  if (valueState.pvl_grop_level) {
    ...
    valueState.pvl_grop_level.map((element) => {
  ...
  const [editorState, seteditorState] = useState(
    EditorState.createWithContent(
      ContentState.createFromBlockArray(convertFromHTML(valueState.pvl_detail))
    )
  );
