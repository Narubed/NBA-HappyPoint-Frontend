      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            ...
            <Typography variant="h5" component="div">
              {bull}
              {numeral(value.rph_point).format('0,0')}
            </Typography>
            <br />
            รายละเอียด
            <Typography variant="h5" component="div">
              {bull}
              {value.rph_detail ? parse(value.rph_detail) : 'ไม่มี'}
            </Typography>
            <br />
            <Typography variant="h5" component="div">
              วันที่ทำรายการ :{' '}
